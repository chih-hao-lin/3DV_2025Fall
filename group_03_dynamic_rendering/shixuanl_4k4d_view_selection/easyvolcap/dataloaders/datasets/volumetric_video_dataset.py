...
class VolumetricVideoDataset(Dataset):
    ...
    def load_cameras(self):
        ...
        print(join(self.data_root, self.intri_file), join(self.data_root, self.extri_file))
        print(exists(join(self.data_root, self.intri_file)), exists(join(self.data_root, self.extri_file)))
