...
def get_parser():
    ...
    parser.add_argument('-t', "--type", type=str, choices=['train', 'test', 'gui', 'tests', 'testr'], default="train", help='Execution mode, train, test or gui')  # evalute, visualize, network, dataset? (only valid when run)
