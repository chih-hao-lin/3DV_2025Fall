...
class LearnedSimulator(nn.Module):
  ...
  def __init__(
    ...
    print("Node input feature size: ", nnode_in)
    print("Edge input feature size: ", nedge_in)
    print("Latent feature size: ", latent_dim)
    print("Number of message passing steps: ", nmessage_passing_steps)
    print("Number of MLP layers: ", nmlp_layers)
    print("MLP hidden layer size: ", mlp_hidden_dim)
    print("Connectivity radius: ", connectivity_radius)
    print("Boundaries: ", boundaries)
    print("Normalization stats: ", normalization_stats)
    print("Number of particle types: ", nparticle_types)
    print("Particle type embedding size: ", particle_type_embedding_size)
    self._device = device
