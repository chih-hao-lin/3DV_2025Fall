...
<h1> Hacker 0: Adheesh Juvekar </h1>
Setup and run as mentioned below in the GWTF Readme.

- Images used for demo: image.png, meme_dog.png, teapot.png. 
- We can can skip step 1 (which needs UI) and directly go to step 2 by using the folders: 'cube', 'cube_mirror', 'meme_dog_glasses', 'teapot', 'teapot_2', 'teapot_3'.
- slides.pptx attached


<h1> Accepted to CVPR 2025 as Oral </h1>

[![Project Page](https://img.shields.io/badge/Project-Page-green?logo=googlechrome&logoColor=green)](https://eyeline-labs.github.io/Go-with-the-Flow/)
...
[![Hugging Face](https://img.shields.io/badge/%F0%9F%A4%97%20Hugging%20Face-Go--with--the--Flow-blue)](https://huggingface.co/Eyeline-Labs/Go-with-the-Flow/tree/main)
