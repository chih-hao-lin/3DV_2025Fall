...
# # Pi3
python stage1_reconstruction/pi3_reconstruction.py \
    --video-dir "./demo_data/input_images/${VIDEO_NAME}/cam01" \
    --out-dir "./demo_data/input_pi3" \
    --start-frame "$START_FRAME" \
    --end-frame "$END_FRAME" \
    --stride "$SUBSAMPLE_FACTOR" \
    --gsam2
...
# MEGASAM_OUTPUT=$(ls -t ./demo_data/input_align3r/align3r_reconstruction_results_${VIDEO_NAME}_cam01_frame_${START_FRAME}_${END_FRAME}_subsample_${SUBSAMPLE_FACTOR}.h5 | head -n 1)
# # MEGASAM_OUTPUT=$(ls -t ./demo_data/input_cut3r/cut3r_reconstruction_results_${VIDEO_NAME}_cam01_frame_${START_FRAME}_${END_FRAME}_subsample_${SUBSAMPLE_FACTOR}.h5 | head -n 1)
MEGASAM_OUTPUT=$(ls -t ./demo_data/input_pi3/pi3_reconstruction_results_${VIDEO_NAME}_cam01_frame_${START_FRAME}_${END_FRAME}_subsample_${SUBSAMPLE_FACTOR}.h5 | head -n 1)
...
# MEGAHUNTER_OUTPUT="./demo_data/output_smpl_and_points/megahunter_cut3r_reconstruction_results_${VIDEO_NAME}_cam01_frame_${START_FRAME}_${END_FRAME}_subsample_${SUBSAMPLE_FACTOR}.h5"
MEGAHUNTER_OUTPUT="./demo_data/output_smpl_and_points/megahunter_pi3_reconstruction_results_${VIDEO_NAME}_cam01_frame_${START_FRAME}_${END_FRAME}_subsample_${SUBSAMPLE_FACTOR}.h5"
# MEGAHUNTER_OUTPUT="./demo_data/output_smpl_and_points/megahunter_align3r_reconstruction_results_${VIDEO_NAME}_cam01_frame_${START_FRAME}_${END_FRAME}_subsample_${SUBSAMPLE_FACTOR}.h5"
...
if [ "$MEGAHUNTER_FLAGS" == "--use-g1-shape" ]; then
    ...
    python stage3_postprocessing/postprocessing_pipeline.py \
        ...
        --out-dir "./demo_data/output_calib_mesh/megahunter_align3r_reconstruction_results_${VIDEO_NAME}_cam01_frame_${START_FRAME}_${END_FRAME}_subsample_${SUBSAMPLE_FACTOR}" \
        --gender "male" \
        # --is-megasam
else
...
python stage4_retargeting/robot_motion_retargeting.py \
    --src-dir "./demo_data/output_calib_mesh/megahunter_align3r_reconstruction_results_${VIDEO_NAME}_cam01_frame_${START_FRAME}_${END_FRAME}_subsample_${SUBSAMPLE_FACTOR}" \
